...
public class Utils {
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        if (authorizationState != null) {
            Utils.authorizationState = authorizationState;
        }
        switch (Utils.authorizationState.getConstructor()) {
            ...
            case TdApi.AuthorizationStateWaitOtherDeviceConfirmation.CONSTRUCTOR: {
                String link = ((TdApi.AuthorizationStateWaitOtherDeviceConfirmation) Utils.authorizationState).link;
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                System.err.println("Unsupported authorization state:" + newLine + Utils.authorizationState);
        }
    }
                        ...
                        switch (object.getConstructor()) {
                            case TdApi.Error.CONSTRUCTOR:
                                if (((TdApi.Error) object).code == 404) {
                                    synchronized (mainChatList) {
                                        Log.d("getMainChatList", "3.  == 404"+" havefullmain: "+haveFullMainChatList);
